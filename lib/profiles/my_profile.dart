...
class MyProfileWidget extends StatefulWidget {
  ...
  const MyProfileWidget(this.currentUserId, this.user, this.isMyProfile, {super.key});
...
class _MyProfileWidgetState extends State<MyProfileWidget> {
  ...
  Future<RegistrationResponseDTO?> _fetchUser() async {
    final user = await FreelanceFinderService.instance.getUserById(widget.currentUserId!);
    return user;
  }
