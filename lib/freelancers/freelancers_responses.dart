...
class OrderResponsesWidget extends StatelessWidget {
  const OrderResponsesWidget({super.key});
              ...
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const FreelancerFiltersWidget()),
                    );
                  },
                  splashColor: Colors.transparent,
                  child: Stack(children: [
                    Transform.scale(
                      scale: 0.8,
                      alignment: Alignment.center,
                      child: Image.asset('assets/images/order_settings.png'),
                    )
                  ]),
                ),
              ),
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const FreelancerProfileWidget()),
                );
              },
              child: SizedBox(
                child: Stack(
